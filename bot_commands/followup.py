...
async def followup(self, interaction: discord.Interaction, question: str) -> None:
            ...
            async with session.post(
                ...
                if resp.status == 200:
                    ...
                    if response_text and response_text.strip():
                        ...
                        log.warning("followup_empty_answer", user_id=user_id, question=question[:100])
                    ...
                    async with session.post(
                        ...
                        if ask_resp.status == 200:
                            ...
                            response_text = f"Failed to get a response. Please try again later."
                else:
    ...
    # Error: show "Try again" button with followup action type
    show_buttons = "no_buttons" if is_success else "try_again"
